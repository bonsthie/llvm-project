...
// CHECK-LABEL: define internal void @"_ZZN19non_inline_function3fooEvENKUliE_clEi"(%class.anon
// CHECK-LABEL: define internal signext i8 @"_ZZZN19non_inline_function3fooEvENKUlcE_clEiENKUlcE_clEc"(%class.anon
