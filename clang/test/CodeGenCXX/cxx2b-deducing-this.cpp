...
//CHECK:  %call = call noundef i32 @_ZZ11test_lambdavENHUlT_E_clIS0_EEiS_()
//CHECK:  ret void
//CHECK: }

//CHECK: define internal noundef i32 @_ZZ11test_lambdavENHUlT_E_clIS0_EEiS_() #0 align 2 {
//CHECK: entry:
...
// CHECK:   %call = call noundef i32 @_ZZ15test_lambda_refvENHUlRT_iE_clIS1_EEiS0_i{{.*}}
// CHECK:   ret void
// CHECK: }

// CHECK: define internal noundef i32 @_ZZ15test_lambda_refvENHUlRT_iE_clIS1_EEiS0_i{{.*}}
// CHECK: entry:
...
// CHECK:  %call = call noundef i32 @_ZZ15test_lambda_refvENHUlRT_iE_clIS1_EEiS0_i(ptr noundef nonnull align 4 dereferenceable(4) %[[this_addr]], i32 noundef %[[j_addr]])
// CHECK:  ret i32 %call
// CHECK: }
...
// CHECK:         call noundef ptr @_ZZN7GH872101fEvENHUlRT_E_clINS_10OverloadedIJS2_EEEEEDaS1_(ptr {{.*}} [[Over]])
void f() {
  int x;
  Overloaded o {
    // CHECK: define internal noundef ptr @_ZZN7GH872101fEvENHUlRT_E_clINS_10OverloadedIJS2_EEEEEDaS1_(ptr {{.*}} [[Self:%.*]])
    // CHECK-NEXT:  entry:
