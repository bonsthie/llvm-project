...
// CHECK-LABEL: define internal void @_ZZN18CaptureByReference5test1EvENKUl_vE_clEv(
...
// CHECK: define internal noundef i32 @_ZZN18CaptureByReference5test2EvENKUlT_E_clIiEEDaS0_(ptr {{[^,]*}} %{{.*}}, i32 noundef %{{.*}})
...
// CHECK: define internal noundef i32 @_ZZN18CaptureByReference5test3EvENKUlT_E_clIiEEDaS0_(ptr {{[^,]*}} %{{.*}}, i32 noundef %{{.*}})
