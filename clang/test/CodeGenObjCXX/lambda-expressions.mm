...
// ARC-LABEL: define internal void @"_ZZ10-[Foo foo]ENKUlvE_clEv"(
...
// ARC-LABEL: define internal void @_ZZN14LambdaDelegate4testEvENUlNS_4WeakEE_8__invokeES0_(
// ARC: call void @_ZZN14LambdaDelegate4testEvENKUlNS_4WeakEE_clES0_(
// ARC-NEXT: ret void

// ARC-LABEL: define internal void @_ZZN14LambdaDelegate4testEvENKUlNS_4WeakEE_clES0_(
